...
public class AppCenterLoader extends ContentProvider {
    ...
    private static final String ENABLE_DISTRIBUTE_IN_DEBUG_KEY = "appcenter_enable_distribute_in_debug";
    ...
    public boolean onCreate() {
        ...
        if (isTrueValue(getStringResource(USE_DISTRIBUTE_KEY)) &&
            ...
            if (isTrueValue(getStringResource(ENABLE_DISTRIBUTE_IN_DEBUG_KEY))) {
