...
#endif
{
     ...
     * - to add '#include <Windows.h>' which provides 'OutputDebugStringW';
     * - to add '#undef GetCurrentDirectory' to fix naming issue;
     * - to enable logging;
     * - to invoke 'OutputDebugStringW' in 'Log' method.
     */
