...
public class PropertiesHelper
{
    ...
    {
        var properties = propertiesContainer.GetComponentsInChildren<DemoEventProperty>();
        ...
        {
            Debug.Log("Adding to property configurator: " + prop.ToString());
    ...
    public static void AddPropertiesToPropertyConfigurator(RectTransform propertiesContainer, PropertyConfigurator configurator)
    {
        ...
        if (properties == null || properties.Length == 0)
        {
            Debug.Log("AddPropertiesToPropertyConfigurator null");
            return;
        }
        foreach (var prop in properties)
        {
