...
.Does(()=>
{
    ...
    if (result != 0)
    {
        throw new Exception("Failed to archive ipa. Result code from xcodebuild: " + result);
    }
    ...
    if (result != 0)
    {
        throw new Exception("Failed to export ipa. Result code from xcodebuild: " + result);
    }
